using System;
using CarrierRatesQueryV2.Api.Features.Rates.QueryByCarrierId;
...
namespace CarrierRatesQueryV2.Tests.Features.Rates.QueryByCarrierId.Unit;

public class QueryByCarrierIdHandlerTests
{
    private static AppDbContext CreateDbContext()
    {
        var options = new DbContextOptionsBuilder<AppDbContext>()
            .UseInMemoryDatabase($"QueryByCarrierId_{Guid.NewGuid()}")
            .Options;
    ...
    [Fact]
    public async Task HandleAsync_ValidId_ReturnsRates()
    {
    ...
    [Fact]
    public async Task HandleAsync_InvalidId_ReturnsNotFound()
    {
        var db = CreateDbContext();
        ...
        {
            // Expected - invalid id results in not found
        }
