using CarrierRatesQueryV2.Api.Features.Carriers.GetById;
...
namespace CarrierRatesQueryV2.Tests.Features.Carriers.GetById.Unit;

public class GetByIdCarrierHandlerTests
{
    private static AppDbContext CreateDbContext()
    {
        var options = new DbContextOptionsBuilder<AppDbContext>()
            .UseInMemoryDatabase($"GetByIdCarrier_{Guid.NewGuid()}")
            .Options;
    ...
    [Fact]
    public async Task HandleAsync_ValidId_ShouldReturnCarrier()
    {
        ...
        endpoint.Response.Name.ShouldBe("Test Carrier");
    }
